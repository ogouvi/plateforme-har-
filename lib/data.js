...
export const hero =
  ...
  [{title1:"Plateforme complète pour accompagner les agriculteurs et les acteurs du domaine agricole",
   ...
   {title1:"Accès rapide aux intrants, equipements et aux differents services technologiques",
   color:"#432A16",
   bgHero: Hero2},
  ...
  //  title1:"Votre processus agricole rendu plus facile pour vous grace au financement et aux appius techniques",
   title1:"Ayez accès au financement et à un vaste marché pour écouler vos recoltes",
   color:"#1AB24B",
   bgHero: Hero3
   }];
