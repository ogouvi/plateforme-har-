...
export const serviceDetails = [
...

  {
    ...
    msg: " Grâce à nos partenariat avec les banques, nous facilitons le processus d'accès aux credits et aux financements des petits producteurs " },
  {
...

  {
    ...
    msg: " Nous offrons aussi des services de stockage aux petit producteurs. Ce qui reduit massivent les pertes post-recoltes"
    + "du aux mauvaises pratiques et techniques de stockage."
...

  {
    ...
    msg: " Nous avons des contrats avec les revendeurs, les restaurants, les hotêls et les entreprises de transformation  à qui nous offrons des produits agricoles recoltés ."
...

  {
   ...
   +"Nous avons la technologies qui nous permet de tester la qualité des produits et et un systeme logistique que nous perment de livrer ces produits en un temps record. "
  },
