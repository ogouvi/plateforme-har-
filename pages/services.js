        ...
        {serviceDetails.map((item, index) => {
          ...
          return (
            <div key={index} className="container mx-auto py-5 flex flex-col  md:flex-row justify-center">
              ...
              <div className="max-w-md p-6 bg-[#23ac16db] border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                ...
                <a className="inline-flex items-center text-slate-300 hover:underline">
                  En savoir plus
