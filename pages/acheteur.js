  ...
  return (
    <div>
      <div class=" relative overflow-hidden md:h-[38rem]">
        {/*<!-- Item 5 -->*/}
        <div class="md:h-full bg-[url('../public/assets/images/pexels-pixabay-221369.jpg')] bg-cover duration-700 ease-in-out" data-carousel-item>
          ...
          <span className=" text-white text-3xl md:text-5xl font-bold flex self-center text-center justify-center py-[12rem] ">Je suis Acheteur de produits <br /> Agricoles </span>
        </div>
      </div>
      ...
      <div className="bg-bg_client md:h-[35rem] flex items-center justify-center">
        <div className=" container flex bg-green-500 bg-opacity-10 md:w-[960px] py-5 ">
          <span className=" text-white text-xl md:text-4xl font-semibold "> Haré.com est une plateforme de confiance qui vous offre des produits 
agricoles de qualité a un prix tres transparant et vous fait livrer 
votre produit en un temps record.
<br/><br/>
Que vous soyez un revendeur, un hotel, un restaurant,
un transformateur, ou encore un agregateur accédez aux prdoduits de qualite tracable et
